            ...
            <nav class="flex items-center space-x-4">
                ...
                @else
                    ...
                    <div class="flex items-center space-x-2 group cursor-pointer relative"
                        ...
                        <div class="flex items-center space-x-2 hover:text-primary-500 transition-colors group">
                            <img src="{{ auth()->user()->profile->avatar
                ? Storage::url(auth()->user()->profile->avatar)
                : 'https://ui-avatars.com/api/?name=' . auth()->user()->username . '&size=128' }}"
                                 alt="Profile Photo" class="rounded-full w-10 h-10 object-cover">
                        </div>
                        <x-icon-caret-down
                            class="w-4 h-4 text-primary-400 group-hover:text-primary-500 transition-colors"/>
