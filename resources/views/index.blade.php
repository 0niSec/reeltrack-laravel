<x-app>
    ...
    <div class="relative">
        ...
        <div class="absolute min-h-screen inset-x-0 -z-10">
            <div class="min-h-screen bg-linear-to-b from-primary-500/20 bg-no-repeat"></div>
        </div>
        ...
        <div class="relative z-10 flex flex-col min-h-screen justify-center">
            <div class="flex flex-col justify-center">
                ...
                hover:bg-primary-500 text-zinc-900 font-bold rounded-lg transform transition hover:scale-105
